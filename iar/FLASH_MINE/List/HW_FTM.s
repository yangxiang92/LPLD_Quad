///////////////////////////////////////////////////////////////////////////////
//                                                                            /
// IAR ANSI C/C++ Compiler V6.40.1.53790/W32 for ARM    07/Aug/2014  15:34:30 /
...
//                    \LPLD\HW\HW_FTM.c -D LPLD_K60 -lCN                      /
...
// E:\ShawnDocuments\IAR_WorkSpace\LPLD_Quad_V3\source\lib\LPLD\HW\HW_FTM.c
//    1 /**
//    2  * @file HW_FTM.c
...
//  560   
//  561   if(ftmx == FTM0)
        LDR.W    R0,??DataTable8_2  ;; 0x40038000
        CMP      R5,R0
...
??LPLD_FTM_EnableIrq_2:
        LDR.W    R0,??DataTable12  ;; 0x400b8000
        CMP      R5,R0
...
??LPLD_FTM_DisableIrq_2:
        LDR.W    R0,??DataTable8_5  ;; 0x400b8000
        CMP      R5,R0
...
//  814         PORTA->PCR[3] = PORTA->PCR[3] & ~PORT_PCR_MUX_MASK | PORT_PCR_MUX(3); 
        ...
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x300
        LDR.W    R4,??DataTable12_2  ;; 0x4004900c
        STR      R0,[R4, #+0]
...
//  816         PORTC->PCR[1] = PORTC->PCR[1] & ~PORT_PCR_MUX_MASK | PORT_PCR_MUX(4);
        ...
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x400
        LDR.W    R4,??DataTable12_3  ;; 0x4004b004
        STR      R0,[R4, #+0]
        B.N      ??LPLD_FTM_PinInit_11
//  817       else
//  818         return 0;
...
//  822         PORTA->PCR[4] = PORTA->PCR[4] & ~PORT_PCR_MUX_MASK | PORT_PCR_MUX(3); 
        ...
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x300
        LDR.W    R4,??DataTable12_4  ;; 0x40049010
        STR      R0,[R4, #+0]
...
//  824         PORTC->PCR[2] = PORTC->PCR[2] & ~PORT_PCR_MUX_MASK | PORT_PCR_MUX(4);
        ...
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x400
        LDR.W    R4,??DataTable12_5  ;; 0x4004b008
        STR      R0,[R4, #+0]
        B.N      ??LPLD_FTM_PinInit_16
//  825       else
//  826         return 0;
...
//  830         PORTA->PCR[5] = PORTA->PCR[5] & ~PORT_PCR_MUX_MASK | PORT_PCR_MUX(3); 
        ...
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x300
        LDR.W    R4,??DataTable12_6  ;; 0x40049014
        STR      R0,[R4, #+0]
...
//  832         PORTC->PCR[3] = PORTC->PCR[3] & ~PORT_PCR_MUX_MASK | PORT_PCR_MUX(4);
        ...
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x400
        LDR.W    R4,??DataTable12_7  ;; 0x4004b00c
        STR      R0,[R4, #+0]
        B.N      ??LPLD_FTM_PinInit_19
//  833       else
//  834         return 0;
...
//  838         PORTA->PCR[6] = PORTA->PCR[6] & ~PORT_PCR_MUX_MASK | PORT_PCR_MUX(3); 
        ...
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x300
        LDR.W    R4,??DataTable12_8  ;; 0x40049018
        STR      R0,[R4, #+0]
...
//  840         PORTC->PCR[4] = PORTC->PCR[4] & ~PORT_PCR_MUX_MASK | PORT_PCR_MUX(4);
        ...
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x400
        LDR.W    R4,??DataTable12_9  ;; 0x4004b010
        STR      R0,[R4, #+0]
        B.N      ??LPLD_FTM_PinInit_22
//  841       else
//  842         return 0;
...
//  846         PORTA->PCR[7] = PORTA->PCR[7] & ~PORT_PCR_MUX_MASK | PORT_PCR_MUX(3); 
        ...
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x300
        LDR.W    R4,??DataTable12_10  ;; 0x4004901c
        STR      R0,[R4, #+0]
...
//  848         PORTD->PCR[4] = PORTD->PCR[4] & ~PORT_PCR_MUX_MASK | PORT_PCR_MUX(4);
        ...
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x400
        LDR.W    R4,??DataTable12_11  ;; 0x4004c010
        STR      R0,[R4, #+0]
        B.N      ??LPLD_FTM_PinInit_25
//  849       else
//  850         return 0;
...
//  854         PORTA->PCR[0] = PORTA->PCR[0] & ~PORT_PCR_MUX_MASK | PORT_PCR_MUX(3); 
        ...
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x300
        LDR.W    R4,??DataTable12_12  ;; 0x40049000
        STR      R0,[R4, #+0]
...
//  856         PORTD->PCR[5] = PORTD->PCR[5] & ~PORT_PCR_MUX_MASK | PORT_PCR_MUX(4);
        ...
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x400
        LDR.W    R4,??DataTable12_13  ;; 0x4004c014
        STR      R0,[R4, #+0]
        B.N      ??LPLD_FTM_PinInit_28
//  857       else
//  858         return 0;
...
//  862         PORTA->PCR[1] = PORTA->PCR[1] & ~PORT_PCR_MUX_MASK | PORT_PCR_MUX(3); 
        ...
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x300
        LDR.W    R4,??DataTable12_14  ;; 0x40049004
        STR      R0,[R4, #+0]
...
//  864         PORTD->PCR[6] = PORTD->PCR[6] & ~PORT_PCR_MUX_MASK | PORT_PCR_MUX(4);
        ...
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x400
        LDR.W    R4,??DataTable12_15  ;; 0x4004c018
        STR      R0,[R4, #+0]
        B.N      ??LPLD_FTM_PinInit_31
//  865       else
//  866         return 0;
...
//  870         PORTA->PCR[2] = PORTA->PCR[2] & ~PORT_PCR_MUX_MASK | PORT_PCR_MUX(3); 
        ...
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x300
        LDR.W    R4,??DataTable12_16  ;; 0x40049008
        STR      R0,[R4, #+0]
...
//  872         PORTD->PCR[7] = PORTD->PCR[7] & ~PORT_PCR_MUX_MASK | PORT_PCR_MUX(4);
        ...
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x400
        LDR.W    R4,??DataTable12_17  ;; 0x4004c01c
        STR      R0,[R4, #+0]
        B.N      ??LPLD_FTM_PinInit_34
//  873       else
//  874         return 0;
...
??LPLD_FTM_PinInit_0:
        LDR.W    R0,??DataTable12_18  ;; 0x40039000
        CMP      R3,R0
...
//  886         PORTA->PCR[8] = PORTA->PCR[8] & ~PORT_PCR_MUX_MASK | PORT_PCR_MUX(3); 
        ...
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x300
        LDR.W    R4,??DataTable12_19  ;; 0x40049020
        STR      R0,[R4, #+0]
...
//  888         PORTA->PCR[12] = PORTA->PCR[12] & ~PORT_PCR_MUX_MASK | PORT_PCR_MUX(3);
        ...
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x300
        LDR.W    R4,??DataTable12_20  ;; 0x40049030
        STR      R0,[R4, #+0]
        B.N      ??LPLD_FTM_PinInit_43
...
//  890         PORTB->PCR[0] = PORTB->PCR[0] & ~PORT_PCR_MUX_MASK | PORT_PCR_MUX(3);
        ...
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x300
        LDR.W    R4,??DataTable12_21  ;; 0x4004a000
        STR      R0,[R4, #+0]
        B.N      ??LPLD_FTM_PinInit_43
//  891       else
//  892         return 0;
...
//  896         PORTA->PCR[9] = PORTA->PCR[9] & ~PORT_PCR_MUX_MASK | PORT_PCR_MUX(3); 
        ...
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x300
        LDR.W    R4,??DataTable12_22  ;; 0x40049024
        STR      R0,[R4, #+0]
...
//  898         PORTA->PCR[13] = PORTA->PCR[13] & ~PORT_PCR_MUX_MASK | PORT_PCR_MUX(3);
        ...
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x300
        LDR.W    R4,??DataTable12_23  ;; 0x40049034
        STR      R0,[R4, #+0]
        B.N      ??LPLD_FTM_PinInit_47
...
//  900         PORTB->PCR[1] = PORTB->PCR[1] & ~PORT_PCR_MUX_MASK | PORT_PCR_MUX(3);
        ...
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x300
        LDR.W    R4,??DataTable12_24  ;; 0x4004a004
        STR      R0,[R4, #+0]
        B.N      ??LPLD_FTM_PinInit_47
//  901       else
//  902         return 0;
...
??LPLD_FTM_PinInit_36:
        LDR.N    R0,??DataTable8_5  ;; 0x400b8000
        CMP      R3,R0
...
//  933         PORTA->PCR[10] = PORTA->PCR[10] & ~PORT_PCR_MUX_MASK | PORT_PCR_MUX(3); 
        ...
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x300
        LDR.W    R4,??DataTable12_25  ;; 0x40049028
        STR      R0,[R4, #+0]
...
//  935         PORTB->PCR[18] = PORTB->PCR[18] & ~PORT_PCR_MUX_MASK | PORT_PCR_MUX(3);
        ...
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x300
        LDR.W    R4,??DataTable12_26  ;; 0x4004a048
        STR      R0,[R4, #+0]
        B.N      ??LPLD_FTM_PinInit_64
//  936       else
//  937         return 0;
...
//  941         PORTA->PCR[11] = PORTA->PCR[11] & ~PORT_PCR_MUX_MASK | PORT_PCR_MUX(3); 
        ...
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x300
        LDR.W    R4,??DataTable12_27  ;; 0x4004902c
        STR      R0,[R4, #+0]
...
//  943         PORTB->PCR[19] = PORTB->PCR[19] & ~PORT_PCR_MUX_MASK | PORT_PCR_MUX(3);
        ...
        BICS     R0,R0,#0x700
        ORRS     R0,R0,#0x300
        LDR.W    R4,??DataTable12_28  ;; 0x4004a04c
        STR      R0,[R4, #+0]
        B.N      ??LPLD_FTM_PinInit_67
//  944       else
//  945         return 0;
...
??LPLD_FTM_PinDeinit_0:
        LDR.N    R0,??DataTable12_18  ;; 0x40039000
        CMP      R2,R0
...
??LPLD_FTM_PinDeinit_28:
        LDR.N    R0,??DataTable12  ;; 0x400b8000
        CMP      R2,R0
