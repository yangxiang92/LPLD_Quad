...
// E:\ShawnDocuments\IAR_WorkSpace\LPLD_Quad_V3\source\lib\LPLD\DEV\DEV_LCD.c
//    1 /**
//    2  * @file DEV_LCD.c
...
//  719       LCD_GRAM[MAX_X*MAX_Y - (j-1)*MAX_Y - (i)] = Color;
        ...
        UXTH     R5,R5            ;; ZeroExt  R5,R5,#+16,#+16
        SUBS     R7,R7,R5
        LDR.W    R12,??DataTable19_4
        LDR      R12,[R12, #+0]
        STRH     R4,[R12, R7, LSL #+1]
//  720     }    
        ADDS     R6,R6,#+1
...
// 3 484 bytes in section .text
// 
// 3 484 bytes of CODE  memory
