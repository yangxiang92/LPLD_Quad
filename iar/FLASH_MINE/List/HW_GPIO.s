...
//   58   {
//   59     portx = PORTA;  
        LDR.N    R0,??DataTable9_3  ;; 0x40049000
        MOVS     R2,R0
//   60     i = 0;
        MOVS     R0,#+0
        MOVS     R1,R0
...
//   62   else if(ptx == PTB) 
??LPLD_GPIO_Init_0:
        LDR.N    R0,??DataTable9_4  ;; 0x400ff040
        CMP      R4,R0
        BNE.N    ??LPLD_GPIO_Init_2
//   63   {
//   64     portx = PORTB;
        LDR.N    R0,??DataTable9_5  ;; 0x4004a000
        MOVS     R2,R0
//   65     i = 1;
        MOVS     R0,#+1
        MOVS     R1,R0
...
//   68   {
//   69     portx = PORTC;
        LDR.N    R0,??DataTable9_7  ;; 0x4004b000
        MOVS     R2,R0
//   70     i = 2;
        MOVS     R0,#+2
        MOVS     R1,R0
...
//   72   else if(ptx == PTD) 
??LPLD_GPIO_Init_3:
        LDR.N    R0,??DataTable9_8  ;; 0x400ff0c0
        CMP      R4,R0
        BNE.N    ??LPLD_GPIO_Init_4
//   73   {
//   74     portx = PORTD;
        LDR.N    R0,??DataTable9_9  ;; 0x4004c000
        MOVS     R2,R0
//   75     i = 3; 
        MOVS     R0,#+3
        MOVS     R1,R0
...
//   77   else if(ptx == PTE) 
??LPLD_GPIO_Init_4:
        LDR.N    R0,??DataTable9_10  ;; 0x400ff100
        CMP      R4,R0
        BNE.N    ??LPLD_GPIO_Init_5
//   78   {
//   79     portx = PORTE;
        LDR.N    R0,??DataTable9_11  ;; 0x4004d000
        MOVS     R2,R0
//   80     i = 4;
        MOVS     R0,#+4
        MOVS     R1,R0
