...
//   79 
//   80   if(spix == SPI0)
        LDR.W    R0,??DataTable8_2  ;; 0x4002c000
        CMP      R1,R0
...
//   87       PORTA->PCR[14] = 0 | PORT_PCR_MUX(2) | PORT_PCR_DSE_MASK;
        LDR.W    R0,??DataTable8_4  ;; 0x40049038
        MOV      R11,#+576
        STR      R11,[R0, #+0]
        B.N      ??LPLD_SPI_Init_2
//   88     }
...
??LPLD_SPI_Init_1:
        LDR.W    R0,??DataTable8_5  ;; 0x4004b010
        MOV      R11,#+576
        STR      R11,[R0, #+0]
//   92     }
//   93     //选择PCS1
...
//   96       PORTC->PCR[3]  = 0 | PORT_PCR_MUX(2) | PORT_PCR_DSE_MASK;
        LDR.W    R0,??DataTable8_6  ;; 0x4004b00c
        MOV      R11,#+576
        STR      R11,[R0, #+0]
        B.N      ??LPLD_SPI_Init_4
//   97     }
...
??LPLD_SPI_Init_3:
        LDR.W    R0,??DataTable8_7  ;; 0x4004c010
        MOV      R11,#+576
        STR      R11,[R0, #+0]
//  101     }
//  102     //选择PCS2
...
??LPLD_SPI_Init_5:
        LDR.W    R0,??DataTable8_9  ;; 0x4004c014
        MOV      R11,#+576
        STR      R11,[R0, #+0]
//  110     }
//  111     //选择PCS3
...
??LPLD_SPI_Init_7:
        LDR.W    R0,??DataTable8_11  ;; 0x4004c018
        MOV      R11,#+576
        STR      R11,[R0, #+0]
//  119     }
//  120     //选择PCS4
...
//  123       PORTC->PCR[0]  = 0 | PORT_PCR_MUX(2) | PORT_PCR_DSE_MASK;
        LDR.W    R0,??DataTable8_12  ;; 0x4004b000
        MOV      R11,#+576
        STR      R11,[R0, #+0]
//  124     }
//  125     //选择PCS5
...
//  128       PORTB->PCR[23] = 0 | PORT_PCR_MUX(3) | PORT_PCR_DSE_MASK;
        LDR.W    R0,??DataTable8_13  ;; 0x4004a05c
        MOV      R11,#+832
        STR      R11,[R0, #+0]
//  129     }
//  130 
...
//  134       PORTA->PCR[15] = 0 | PORT_PCR_MUX(2) | PORT_PCR_DSE_MASK;//SCK
        LDR.W    R0,??DataTable8_14  ;; 0x4004903c
        MOV      R11,#+576
        STR      R11,[R0, #+0]
...
??LPLD_SPI_Init_11:
        LDR.W    R0,??DataTable8_15  ;; 0x4004b014
        MOV      R11,#+576
        STR      R11,[R0, #+0]
//  139     }
//  140     //选择MOSI
...
//  143       PORTA->PCR[16] = 0 | PORT_PCR_MUX(2) | PORT_PCR_DSE_MASK;//SOUT
        LDR.W    R0,??DataTable8_16  ;; 0x40049040
        MOV      R11,#+576
        STR      R11,[R0, #+0]
...
??LPLD_SPI_Init_13:
        LDR.W    R0,??DataTable8_17  ;; 0x4004b018
        MOV      R11,#+576
        STR      R11,[R0, #+0]
//  148     }
//  149     //选择MISO
...
//  152       PORTA->PCR[17] = 0 | PORT_PCR_MUX(2); //SIN
        LDR.W    R0,??DataTable8_18  ;; 0x40049044
        MOV      R11,#+512
        STR      R11,[R0, #+0]
...
??LPLD_SPI_Init_15:
        LDR.W    R0,??DataTable8_19  ;; 0x4004b01c
        MOV      R11,#+512
        STR      R11,[R0, #+0]
        B.N      ??LPLD_SPI_Init_16
//  157     } 
...
??LPLD_SPI_Init_0:
        LDR.W    R0,??DataTable8_20  ;; 0x4002d000
        CMP      R1,R0
...
//  166       PORTB->PCR[10] = 0 | PORT_PCR_MUX(2) | PORT_PCR_DSE_MASK;
        LDR.W    R0,??DataTable8_21  ;; 0x4004a028
        MOV      R11,#+576
        STR      R11,[R0, #+0]
...
??LPLD_SPI_Init_18:
        LDR.W    R0,??DataTable8_22  ;; 0x4004d010
        MOV      R11,#+576
        STR      R11,[R0, #+0]
//  171     }
//  172     //选择PCS1
...
//  175       PORTB->PCR[9]  = 0 | PORT_PCR_MUX(2) | PORT_PCR_DSE_MASK;
        LDR.W    R0,??DataTable8_23  ;; 0x4004a024
        MOV      R11,#+576
        STR      R11,[R0, #+0]
...
??LPLD_SPI_Init_20:
        LDR.W    R0,??DataTable8_24  ;; 0x4004d000
        MOV      R11,#+576
        STR      R11,[R0, #+0]
//  180     }
//  181     //选择PCS2
...
//  184       PORTE->PCR[5]  = 0 | PORT_PCR_MUX(2) | PORT_PCR_DSE_MASK;
        LDR.W    R0,??DataTable8_25  ;; 0x4004d014
        MOV      R11,#+576
        STR      R11,[R0, #+0]
//  185     }
//  186 
...
//  190       PORTE->PCR[6]  = 0 | PORT_PCR_MUX(2) | PORT_PCR_DSE_MASK;
        LDR.W    R0,??DataTable8_26  ;; 0x4004d018
        MOV      R11,#+576
        STR      R11,[R0, #+0]
//  191     }
//  192 
...
//  196       PORTB->PCR[11] = 0 | PORT_PCR_MUX(2) | PORT_PCR_DSE_MASK;
        LDR.W    R0,??DataTable8_27  ;; 0x4004a02c
        MOV      R11,#+576
        STR      R11,[R0, #+0]
...
??LPLD_SPI_Init_24:
        LDR.W    R0,??DataTable8_28  ;; 0x4004d008
        MOV      R11,#+576
        STR      R11,[R0, #+0]
//  201     }
//  202     //选择MOSI
...
//  205       PORTB->PCR[16] = 0 | PORT_PCR_MUX(2) | PORT_PCR_DSE_MASK;//SOUT
        LDR.W    R0,??DataTable8_29  ;; 0x4004a040
        MOV      R11,#+576
        STR      R11,[R0, #+0]
...
??LPLD_SPI_Init_26:
        LDR.W    R0,??DataTable8_30  ;; 0x4004d004
        MOV      R11,#+576
        STR      R11,[R0, #+0]
//  210     }
//  211     //选择MISO
...
//  214       PORTB->PCR[17] = 0 | PORT_PCR_MUX(2); //SIN
        LDR.W    R0,??DataTable8_31  ;; 0x4004a044
        MOV      R11,#+512
        STR      R11,[R0, #+0]
        B.N      ??LPLD_SPI_Init_16
//  215     }
...
??LPLD_SPI_Init_28:
        LDR.W    R0,??DataTable8_32  ;; 0x4004d00c
        MOV      R11,#+512
        STR      R11,[R0, #+0]
        B.N      ??LPLD_SPI_Init_16
//  219     } 
...
??LPLD_SPI_Init_17:
        LDR.W    R0,??DataTable8_33  ;; 0x400ac000
        CMP      R1,R0
        BNE.N    ??LPLD_SPI_Init_29
//  222   {
//  223     SIM->SCGC3 |= SIM_SCGC3_SPI2_MASK;
        LDR.W    R0,??DataTable8_34  ;; 0x40048030
        LDR      R0,[R0, #+0]
        ORRS     R0,R0,#0x1000
        LDR.W    R11,??DataTable8_34  ;; 0x40048030
        STR      R0,[R11, #+0]
//  224     //选择PCS0
...
//  227       PORTD->PCR[11] = 0 | PORT_PCR_MUX(2) | PORT_PCR_DSE_MASK;
        LDR.W    R0,??DataTable8_35  ;; 0x4004c02c
        MOV      R11,#+576
        STR      R11,[R0, #+0]
...
??LPLD_SPI_Init_30:
        LDR.W    R0,??DataTable8_36  ;; 0x4004a050
        MOV      R11,#+576
        STR      R11,[R0, #+0]
//  232     }
//  233     //选择PCS1
...
//  236       PORTD->PCR[15]  = 0 | PORT_PCR_MUX(2) | PORT_PCR_DSE_MASK;
        LDR.W    R0,??DataTable8_37  ;; 0x4004c03c
        MOV      R11,#+576
        STR      R11,[R0, #+0]
//  237     }
//  238 
...
//  242       PORTD->PCR[12] = 0 | PORT_PCR_MUX(2) | PORT_PCR_DSE_MASK;
        LDR.W    R0,??DataTable8_38  ;; 0x4004c030
        MOV      R11,#+576
        STR      R11,[R0, #+0]
...
??LPLD_SPI_Init_33:
        LDR.W    R0,??DataTable8_39  ;; 0x4004a054
        MOV      R11,#+576
        STR      R11,[R0, #+0]
//  247     }
//  248     //选择MOSI
...
//  251       PORTD->PCR[13] = 0 | PORT_PCR_MUX(2) | PORT_PCR_DSE_MASK;//SOUT
        LDR.W    R0,??DataTable8_40  ;; 0x4004c034
        MOV      R11,#+576
        STR      R11,[R0, #+0]
...
??LPLD_SPI_Init_35:
        LDR.W    R0,??DataTable8_41  ;; 0x4004a058
        MOV      R11,#+576
        STR      R11,[R0, #+0]
//  256     }
//  257     //选择MISO
...
//  260       PORTD->PCR[14] = 0 | PORT_PCR_MUX(2); //SIN
        LDR.W    R0,??DataTable8_42  ;; 0x4004c038
        MOV      R11,#+512
        STR      R11,[R0, #+0]
        B.N      ??LPLD_SPI_Init_16
//  261     }
...
??LPLD_SPI_Init_16:
        LDR.W    R0,??DataTable8_43  ;; 0x3f0c01
        STR      R0,[R1, #+0]
//  275   //选择SPI 工作模式
...
//  446               |SPI_SR_EOQF_MASK;
        LDR.W    R0,??DataTable8_47  ;; 0x9a0a0000
        STR      R0,[R1, #+44]
//  447   //使能SPIx
...
//  483     SIM->SCGC3 &= ~SIM_SCGC3_SPI2_MASK;
        ...
        LDR      R0,[R0, #+0]
        BICS     R0,R0,#0x1000
        LDR.W    R1,??DataTable8_34  ;; 0x40048030
        STR      R0,[R1, #+0]
        B.N      ??LPLD_SPI_Deinit_1
//  484   }
//  485   else
...
//  537   SPI_Type * spix = spi_init_structure.SPI_SPIx;
        LDR      R4,[SP, #+8]
//  538   if(spix == SPI0)
        LDR.N    R0,??DataTable8_2  ;; 0x4002c000
        CMP      R4,R0
...
??LPLD_SPI_DisableIrq_0:
        LDR.N    R0,??DataTable8_20  ;; 0x4002d000
        CMP      R4,R0
