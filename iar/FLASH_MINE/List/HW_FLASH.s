...
//                    \LPLD\HW\HW_FLASH.c -D LPLD_K60 -lCN                    /
...
// E:\ShawnDocuments\IAR_WorkSpace\LPLD_Quad_V3\source\lib\LPLD\HW\HW_FLASH.c
//    1 /**
//    2  * @file HW_FLASH.c
...
//  145     FTFL->FCCOB0 = FLASH_CMD_PGM4;
        LDR.N    R0,??DataTable2_3  ;; 0x40020007
        MOVS     R6,#+6
        STRB     R6,[R0, #+0]
...
//  153     FTFL->FCCOB7 = (uint8)(*((uint8*)DataSrcPtr+0));
        LDR.N    R0,??DataTable2_10  ;; 0x40020008
        LDRB     R6,[R1, #+0]
        STRB     R6,[R0, #+0]
