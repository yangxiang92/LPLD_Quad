...
//                    \LPLD\HW\HW_ADC.c -D LPLD_K60 -lCN                      /
...
// E:\ShawnDocuments\IAR_WorkSpace\LPLD_Quad_V3\source\lib\LPLD\HW\HW_ADC.c
//    1 /**
//    2  * @file HW_ADC.c
...
??LPLD_ADC_Init_0:
        LDR.W    R0,??DataTable8_4  ;; 0x400bb000
        CMP      R4,R0
...
//   74     SIM->SCGC3 |= SIM_SCGC3_ADC1_MASK;   // 开启ADC1时钟
        LDR.W    R0,??DataTable8_5  ;; 0x40048030
        LDR      R0,[R0, #+0]
        ORRS     R0,R0,#0x8000000
        LDR.W    R1,??DataTable8_5  ;; 0x40048030
        STR      R0,[R1, #+0]
        B.N      ??LPLD_ADC_Init_1
//   75   }
//   76   else 
...
//  155     SIM->SCGC3 &= ~(SIM_SCGC3_ADC1_MASK);   // 关闭ADC1时钟
        ...
        LDR      R0,[R0, #+0]
        BICS     R0,R0,#0x8000000
        LDR.W    R3,??DataTable8_5  ;; 0x40048030
        STR      R0,[R3, #+0]
        B.N      ??LPLD_ADC_Deinit_1
//  156   }
//  157   else 
...
//  339   
//  340   if(adcx == ADC0)
        LDR.N    R0,??DataTable8_2  ;; 0x4003b000
        CMP      R5,R0
...
??LPLD_ADC_EnableIrq_0:
        LDR.N    R0,??DataTable8_4  ;; 0x400bb000
        CMP      R5,R0
...
//  471           PORTC->PCR[2] =  PORT_PCR_MUX(0);
        LDR.N    R0,??DataTable8_7  ;; 0x4004b008
        MOVS     R4,#+0
        STR      R4,[R0, #+0]
//  472         break;
...
//  475           PORTD->PCR[1] =  PORT_PCR_MUX(0);
        LDR.N    R0,??DataTable8_8  ;; 0x4004c004
        MOVS     R4,#+0
        STR      R4,[R0, #+0]
//  476         break;
...
??LPLD_ADC_Chn_Enable_26:
        UXTB     R1,R1            ;; ZeroExt  R1,R1,#+24,#+24
        LDR.N    R0,??DataTable8_9  ;; 0x40049000
        MOVS     R4,#+0
        STR      R4,[R0, R1, LSL #+2]
//  552         break;
        B.N      ??LPLD_ADC_Chn_Enable_15
