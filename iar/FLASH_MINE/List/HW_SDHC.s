...
//                    \LPLD\HW\HW_SDHC.c -D LPLD_K60 -lCN                     /
...
// E:\ShawnDocuments\IAR_WorkSpace\LPLD_Quad_V3\source\lib\LPLD\HW\HW_SDHC.c
//    1 /**
//    2  * @file HW_SDHC.c
...
//  168   SDHC->SYSCTL = SDHC_SYSCTL_RSTA_MASK | SDHC_SYSCTL_SDCLKFS(0x80);
        ...
        LDR.W    R1,??DataTable8_9  ;; 0x1008000
        STR      R1,[R0, #+0]
...
//  172   //初始化寄存器值
//  173   SDHC->VENDOR = 0;
        LDR.W    R0,??DataTable8_10  ;; 0x400b10c0
        MOVS     R1,#+0
        STR      R1,[R0, #+0]
...
//  176   SDHC->WML = SDHC_WML_RDWML(2) | SDHC_WML_WRWML(1);
        LDR.W    R0,??DataTable8_12  ;; 0x400b1044
        LDR.W    R1,??DataTable8_13  ;; 0x10002
        STR      R1,[R0, #+0]
//  177   
...
//  193         | SDHC_IRQSTATEN_TCSEN_MASK | SDHC_IRQSTATEN_CCSEN_MASK;
        LDR.W    R0,??DataTable8_14  ;; 0x400b1034
        LDR.W    R1,??DataTable9_3  ;; 0x7f00b3
        STR      R1,[R0, #+0]
//  194   
//  195   //等待80个初始时钟
...
//  271   SDHC->BLKATTR = blkattr;
        ...
        STR      R5,[R0, #+0]
//  272   SDHC->DSADDR = 0;
        LDR.W    R0,??DataTable10_1  ;; 0x400b1000
        MOVS     R1,#+0
        STR      R1,[R0, #+0]
//  273   
//  274   //发送命令
...
??LPLD_SDHC_IOC_11:
        LDR.W    R0,??DataTable11  ;; 0x81a0000
        STR      R0,[SP, #+0]
...
??LPLD_SDHC_IOC_13:
        LDR.W    R0,??DataTable11_1  ;; 0x5020000
        STR      R0,[SP, #+0]
...
//  431       command.COMMAND = ESDHC_CMD55;
        LDR.W    R0,??DataTable11_2  ;; 0x371a0000
        STR      R0,[SP, #+0]
...
//  447         command.ARGUMENT = 0x40300000;
        LDR.W    R0,??DataTable11_3  ;; 0x40300000
        STR      R0,[SP, #+4]
...
//  460         command.COMMAND = ESDHC_CMD39;
        LDR.W    R0,??DataTable11_4  ;; 0x27020000
        STR      R0,[SP, #+0]
...
??LPLD_SDHC_IOC_25:
        LDR.W    R0,??DataTable11_5  ;; 0x29020000
        STR      R0,[SP, #+0]
...
//  583     LPLD_SDHC_SetBaudrate (g_core_clock*1000, 25000000);
        LDR.W    R1,??DataTable11_6  ;; 0x17d7840
        LDR.W    R0,??DataTable10_9
        LDR      R0,[R0, #+0]
        MOV      R2,#+1000
        MULS     R0,R2,R0
...
??LPLD_SDHC_Read_5:
        LDR.W    R0,??DataTable11_7  ;; 0x400b1020
        LDR      R0,[R0, #+0]
        STR      R0,[R2, #+0]
//  786       data_ptr += 4;
        ADDS     R2,R2,#+4
...
// 1038   command.COMMAND = ESDHC_CMD9;
        LDR.W    R0,??DataTable11_10  ;; 0x9090000
        STR      R0,[SP, #+4]
...
??LPLD_SDHC_InitCard_15:
        LDR.N    R0,??DataTable11_6  ;; 0x17d7840
        STR      R0,[SP, #+0]
...
??LPLD_SDHC_InitCard_18:
        LDR.N    R0,??DataTable11_2  ;; 0x371a0000
        STR      R0,[SP, #+4]
...
// 1144     command.COMMAND = ESDHC_CMD18;
        LDR.N    R0,??DataTable11_15  ;; 0x121a0034
        STR      R0,[SP, #+0]
...
??LPLD_SDHC_ReadBlocks_1:
        LDR.N    R0,??DataTable11_16  ;; 0x111a0010
        STR      R0,[SP, #+0]
// 1149   }
// 1150   
...
// 1208         command.COMMAND = ESDHC_CMD25;
        LDR.N    R0,??DataTable11_17  ;; 0x191a0024
        STR      R0,[SP, #+4]
...
??LPLD_SDHC_WriteBlocks_1:
        LDR.N    R0,??DataTable11_18  ;; 0x181a0000
        STR      R0,[SP, #+4]
// 1213     }
// 1214 
...
??LPLD_SDHC_WriteBlocks_9:
        LDR      R0,[SP, #+20]
        LDR.N    R1,??DataTable11_20  ;; 0xffd98008
        TST      R0,R1
...
??LPLD_SDHC_WriteBlocks_13:
        LDR.N    R0,??DataTable11_21  ;; 0x161a0010
        STR      R0,[SP, #+4]
