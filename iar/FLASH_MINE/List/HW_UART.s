...
//                    \LPLD\HW\HW_UART.c -D LPLD_K60 -lCN                     /
...
// E:\ShawnDocuments\IAR_WorkSpace\LPLD_Quad_V3\source\lib\LPLD\HW\HW_UART.c
//    1 /**
//    2  * @file HW_UART.c
...
//   68       PORTA->PCR[2] = PORT_PCR_MUX(2); 
        LDR.W    R9,??DataTable10_5  ;; 0x40049008
        MOV      R10,#+512
        STR      R10,[R9, #+0]
...
//   70       PORTA->PCR[14] = PORT_PCR_MUX(3); 
        LDR.W    R9,??DataTable10_6  ;; 0x40049038
        MOV      R10,#+768
        STR      R10,[R9, #+0]
        B.N      ??LPLD_UART_Init_3
//   71     else
...
??LPLD_UART_Init_4:
        LDR.W    R9,??DataTable10_7  ;; 0x4004a044
        MOV      R10,#+768
        STR      R10,[R9, #+0]
//   73     
//   74     if(rx_pin == PTA1)
...
//   75       PORTA->PCR[1] = PORT_PCR_MUX(2); 
        LDR.W    R9,??DataTable10_8  ;; 0x40049004
        MOV      R10,#+512
        STR      R10,[R9, #+0]
...
//   77       PORTA->PCR[15] = PORT_PCR_MUX(3); 
        LDR.W    R9,??DataTable10_9  ;; 0x4004903c
        MOV      R10,#+768
        STR      R10,[R9, #+0]
        B.N      ??LPLD_UART_Init_6
//   78     else
...
??LPLD_UART_Init_7:
        LDR.W    R9,??DataTable10_10  ;; 0x4004a040
        MOV      R10,#+768
        STR      R10,[R9, #+0]
        B.N      ??LPLD_UART_Init_6
//   80   }
...
//   90         PORTE->PCR[0] = PORT_PCR_MUX(3); 
        LDR.W    R9,??DataTable10_12  ;; 0x4004d000
        MOV      R10,#+768
        STR      R10,[R9, #+0]
...
??LPLD_UART_Init_9:
        LDR.W    R9,??DataTable10_13  ;; 0x4004b010
        MOV      R10,#+768
        STR      R10,[R9, #+0]
//   93       
//   94       if(rx_pin == PTE1)
...
//   95         PORTE->PCR[1] = PORT_PCR_MUX(3); 
        LDR.W    R9,??DataTable10_14  ;; 0x4004d004
        MOV      R10,#+768
        STR      R10,[R9, #+0]
        B.N      ??LPLD_UART_Init_6
//   96       else
...
??LPLD_UART_Init_11:
        LDR.W    R9,??DataTable10_15  ;; 0x4004b00c
        MOV      R10,#+768
        STR      R10,[R9, #+0]
        B.N      ??LPLD_UART_Init_6
//   98     }
...
//  107         PORTD->PCR[3] = PORT_PCR_MUX(3); 
        LDR.W    R9,??DataTable10_18  ;; 0x4004c00c
        MOV      R10,#+768
        STR      R10,[R9, #+0]
//  108         PORTD->PCR[2] = PORT_PCR_MUX(3);
        LDR.W    R9,??DataTable10_19  ;; 0x4004c008
        MOV      R10,#+768
        STR      R10,[R9, #+0]
        B.N      ??LPLD_UART_Init_6
//  109       }
...
//  118             PORTE->PCR[4] = PORT_PCR_MUX(3); 
        LDR.W    R9,??DataTable10_21  ;; 0x4004d010
        MOV      R10,#+768
        STR      R10,[R9, #+0]
...
//  120             PORTB->PCR[11] = PORT_PCR_MUX(3); 
        LDR.W    R9,??DataTable10_22  ;; 0x4004a02c
        MOV      R10,#+768
        STR      R10,[R9, #+0]
        B.N      ??LPLD_UART_Init_15
//  121           else 
...
??LPLD_UART_Init_16:
        LDR.W    R9,??DataTable10_23  ;; 0x4004b044
        MOV      R10,#+768
        STR      R10,[R9, #+0]
//  123           
//  124           if(rx_pin == PTE5)
...
//  125             PORTE->PCR[5] = PORT_PCR_MUX(3); 
        LDR.W    R9,??DataTable10_24  ;; 0x4004d014
        MOV      R10,#+768
        STR      R10,[R9, #+0]
        B.N      ??LPLD_UART_Init_6
...
//  127             PORTB->PCR[10] = PORT_PCR_MUX(3); 
        LDR.W    R9,??DataTable10_25  ;; 0x4004a028
        MOV      R10,#+768
        STR      R10,[R9, #+0]
        B.N      ??LPLD_UART_Init_6
//  128           else
...
??LPLD_UART_Init_18:
        LDR.W    R9,??DataTable10_26  ;; 0x4004b040
        MOV      R10,#+768
        STR      R10,[R9, #+0]
        B.N      ??LPLD_UART_Init_6
//  130         }
...
//  139               PORTE->PCR[24] = PORT_PCR_MUX(3); 
        LDR.W    R9,??DataTable10_29  ;; 0x4004d060
        MOV      R10,#+768
        STR      R10,[R9, #+0]
...
??LPLD_UART_Init_20:
        LDR.W    R9,??DataTable10_30  ;; 0x4004b03c
        MOV      R10,#+768
        STR      R10,[R9, #+0]
//  142             
//  143             if(rx_pin == PTE25)
...
//  144               PORTE->PCR[25] = PORT_PCR_MUX(3); 
        LDR.W    R9,??DataTable10_31  ;; 0x4004d064
        MOV      R10,#+768
        STR      R10,[R9, #+0]
        B.N      ??LPLD_UART_Init_6
//  145             else
...
??LPLD_UART_Init_22:
        LDR.W    R9,??DataTable10_32  ;; 0x4004b038
        MOV      R10,#+768
        STR      R10,[R9, #+0]
        B.N      ??LPLD_UART_Init_6
//  147           }
...
//  155               PORTD->PCR[9] = PORT_PCR_MUX(3); 
        LDR.W    R9,??DataTable10_34  ;; 0x4004c024
        MOV      R10,#+768
        STR      R10,[R9, #+0]
...
??LPLD_UART_Init_23:
        LDR.W    R9,??DataTable10_35  ;; 0x4004d020
        MOV      R10,#+768
        STR      R10,[R9, #+0]
//  158             
//  159             if(rx_pin == PTD8)
...
//  160               PORTD->PCR[8] = PORT_PCR_MUX(3); 
        LDR.W    R9,??DataTable10_36  ;; 0x4004c020
        MOV      R10,#+768
        STR      R10,[R9, #+0]
        B.N      ??LPLD_UART_Init_6
//  161             else
...
??LPLD_UART_Init_25:
        LDR.W    R9,??DataTable10_37  ;; 0x4004d024
        MOV      R10,#+768
        STR      R10,[R9, #+0]
//  163           }
//  164         }
