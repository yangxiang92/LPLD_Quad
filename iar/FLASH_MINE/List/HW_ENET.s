...
//                    \LPLD\HW\HW_ENET.c -D LPLD_K60 -lCN                     /
...
// E:\ShawnDocuments\IAR_WorkSpace\LPLD_Quad_V3\source\lib\LPLD\HW\HW_ENET.c
//    1 /**
//    2  * @file HW_ENET.c
...
//   58   //允许并发访问MPU控制器
//   59   MPU->CESR = 0;         
        LDR.W    R0,??DataTable14_2  ;; 0x4000d000
        MOVS     R1,#+0
        STR      R1,[R0, #+0]
//   60         
//   61   //缓冲区描述符初始化
...
//  163   //清除单独和组地址哈希寄存器
//  164   ENET->IALR = 0;
        LDR.W    R0,??DataTable14_25  ;; 0x400c011c
        MOVS     R1,#+0
        STR      R1,[R0, #+0]
//  165   ENET->IAUR = 0;
        LDR.W    R0,??DataTable14_26  ;; 0x400c0118
        MOVS     R1,#+0
        STR      R1,[R0, #+0]
//  166   ENET->GALR = 0;
        LDR.W    R0,??DataTable14_27  ;; 0x400c0124
        MOVS     R1,#+0
        STR      R1,[R0, #+0]
//  167   ENET->GAUR = 0;
        LDR.W    R0,??DataTable14_28  ;; 0x400c0120
        MOVS     R1,#+0
        STR      R1,[R0, #+0]
//  168   
//  169   //设置ENET模块MAC地址
...
//  173   ENET->RCR = ENET_RCR_MAX_FL(CFG_ENET_MAX_PACKET_SIZE) | ENET_RCR_MII_MODE_MASK | ENET_RCR_CRCFWD_MASK | ENET_RCR_RMII_MODE_MASK;
        LDR.W    R0,??DataTable14_29  ;; 0x400c0084
        LDR.W    R1,??DataTable14_30  ;; 0x5f04104
        STR      R1,[R0, #+0]
//  174 
//  175   //清除发送接收控制
//  176   ENET->TCR = 0;
...
//  182     ENET->RCR &= (uint32)~ENET_RCR_DRT_MASK;
        ...
        LDR      R0,[R0, #+0]
        BICS     R0,R0,#0x2
        LDR.W    R1,??DataTable14_29  ;; 0x400c0084
        STR      R0,[R1, #+0]
...
//  204   ENET->MRBR = (unsigned short) CFG_ENET_RX_BUFFER_SIZE;
        LDR.W    R0,??DataTable14_32  ;; 0x400c0188
        MOV      R1,#+256
        STR      R1,[R0, #+0]
//  205 
//  206   //指向环形接收缓冲区描述符序列的头地址
//  207   ENET->RDSR = ( uint32 ) &( xENETRxDescriptors[ 0 ] );
        LDR.W    R0,??DataTable14_33  ;; 0x400c0180
        LDR.W    R1,??DataTable14_34
        LDR      R1,[R1, #+0]
        STR      R1,[R0, #+0]
//  208 
//  209   //指向环形发送缓冲区描述符序列的头地址
//  210   ENET->TDSR = ( uint32 ) xENETTxDescriptors;
        LDR.W    R0,??DataTable14_35  ;; 0x400c0184
        LDR.W    R1,??DataTable14_36
        LDR      R1,[R1, #+0]
        STR      R1,[R0, #+0]
//  211 
//  212   //清除ENET中断事件
...
//  222             ;
        LDR.W    R0,??DataTable14_38  ;; 0x400c0008
        LDR.W    R1,??DataTable14_39  ;; 0x6b780000
        STR      R1,[R0, #+0]
//  223 
//  224   //使能ENET模块
...
//  228   ENET->RDAR = ENET_RDAR_RDAR_MASK;
        LDR.W    R0,??DataTable14_40  ;; 0x400c0010
        MOVS     R1,#+16777216
        STR      R1,[R0, #+0]
//  229 }
        POP      {R0}
...
??LPLD_ENET_BDInit_9:
        LDR.N    R2,??DataTable14_36
        LDR      R2,[R2, #+0]
        LDRH     R2,[R2, #+0]
        ORRS     R2,R2,#0x20
        LDR.N    R3,??DataTable14_36
        LDR      R3,[R3, #+0]
        STRH     R2,[R3, #+0]
...
??LPLD_ENET_MacSend_1:
        LDR.N    R2,??DataTable14_46  ;; 0x400c0014
        MOVS     R3,#+16777216
        STR      R3,[R2, #+0]
//  437   
//  438 }
...
//  477   ENET->RDAR = ENET_RDAR_RDAR_MASK;	
        LDR.N    R0,??DataTable14_40  ;; 0x400c0010
        MOVS     R1,#+16777216
        STR      R1,[R0, #+0]
//  478   return 0;
        MOVS     R0,#+0
