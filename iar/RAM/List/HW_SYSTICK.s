...
// E:\ShawnDocuments\IAR_WorkSpace\LPLD_Quad_V2\source\lib\LPLD\HW\HW_SYSTICK.c
//    1 /**
//    2  * @file HW_SYSTICK.c
...
??LPLD_SYSTICK_Init_1:
        LDR.N    R3,??DataTable7_6  ;; 0xe000e010
        LDR.N    R5,??DataTable7_7  ;; 0x10004
        STR      R5,[R3, #+0]
...
//   61     SYSTICK->CSR |= SYSTICK_CSR_TICKINT_MASK;  //使能systick中断
        ...
        LDR      R3,[R3, #+0]
        ORRS     R3,R3,#0x2
        LDR.N    R5,??DataTable7_6  ;; 0xe000e010
        STR      R3,[R5, #+0]
...
??LPLD_SYSTICK_Init_2:
        ...
        STR      R0,[R1, #+0]
//   67   SYSTICK->CVR = 0x00;  
        LDR.N    R0,??DataTable7_10  ;; 0xe000e018
        MOVS     R1,#+0
        STR      R1,[R0, #+0]
//   68   SYSTICK->CSR |= SYSTICK_CSR_ENABLE_MASK;  //使能SYSTICK
        LDR.N    R0,??DataTable7_6  ;; 0xe000e010
        LDR      R0,[R0, #+0]
        ORRS     R0,R0,#0x1
        LDR.N    R1,??DataTable7_6  ;; 0xe000e010
        STR      R0,[R1, #+0]
//   69 }
??LPLD_SYSTICK_Init_0:
