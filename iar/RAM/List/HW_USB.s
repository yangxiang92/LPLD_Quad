...
//                    \LPLD\HW\HW_USB.c -D LPLD_K60 -lCN                      /
...
// E:\ShawnDocuments\IAR_WorkSpace\LPLD_Quad_V2\source\lib\LPLD\HW\HW_USB.c
//    1 /**
//    2  * @file HW_USB.c
...
//   38   MPU->CESR=0; //MPU 配置 
        LDR.N    R0,??DataTable2_1  ;; 0x4000d000
        MOVS     R1,#+0
        STR      R1,[R0, #+0]
...
//   42   SIM->CLKDIV2 = 0x02;                    //设置分频系数USB时钟 = 96Mhz/2 =48Mhz
        LDR.N    R0,??DataTable2_3  ;; 0x40048048
        MOVS     R1,#+2
        STR      R1,[R0, #+0]
//   43 #endif 
...
//   45   USB0->USBTRC0 = 0x40;                   //按照文档所述，此位必须设置为1
        LDR.N    R0,??DataTable2_5  ;; 0x4007210c
        MOVS     R1,#+64
        STRB     R1,[R0, #+0]
