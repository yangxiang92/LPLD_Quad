///////////////////////////////////////////////////////////////////////////////
//                                                                            /
// IAR ANSI C/C++ Compiler V6.40.1.53790/W32 for ARM    21/Mar/2014  16:54:53 /
...
// E:\ShawnDocuments\IAR_WorkSpace\LPLD_Quad_V2\source\lib\LPLD\HW\HW_TSI.c
//    1 /**
//    2  * @file HW_TSI.c
...
//   91                   |(TSI_SCANC_AMPSC(0)));       //输入时钟(2^0)分频
        LDR.N    R0,??DataTable4_5  ;; 0x40045004
        LDR.N    R1,??DataTable4_6  ;; 0xf81f0000
        STR      R1,[R0, #+0]
//   92   //使能通道
//   93   TSI0->PEN = chs;
...
??LPLD_TSI_Init_13:
        ...
        CMP      R1,#+200
        BCC.N    ??LPLD_TSI_Init_12
        ADDS     R0,R0,#+1
??LPLD_TSI_Init_11:
        MOVW     R1,#+5000
        UXTH     R0,R0            ;; ZeroExt  R0,R0,#+16,#+16
        CMP      R0,R1
        BCS.N    ??LPLD_TSI_Init_14
        MOVS     R1,#+0
...
//  229     TSI0->STATUS = 0xFFFF0000;
        LDR.N    R0,??DataTable4_12  ;; 0x4004500c
        LDR.N    R1,??DataTable4_13  ;; 0xffff0000
        STR      R1,[R0, #+0]
//  230   }
//  231     
//  232 #if (UCOS_II > 0u)
...
`?<Constant "E:\\\\ShawnDocuments\\\\IAR...">`:
        ...
        DC8 48H, 57H, 5FH, 54H, 53H, 49H, 2EH, 63H
        DC8 0
        DC8 0, 0, 0
