///////////////////////////////////////////////////////////////////////////////
//                                                                            /
// IAR ANSI C/C++ Compiler V6.40.1.53790/W32 for ARM    21/Mar/2014  14:38:47 /
...
// E:\ShawnDocuments\IAR_WorkSpace\LPLD_Quad_V2\source\lib\LPLD\HW\HW_ENET.c
//    1 /**
//    2  * @file HW_ENET.c
...
??LPLD_ENET_MacSend_1:
        LDR.N    R0,??DataTable14_46  ;; 0x400c0014
        MOVS     R1,#+16777216
        STR      R1,[R0, #+0]
//  437   
//  438 }
...
//  587   ENET->EIR = ENET_EIR_MII_MASK;
        LDR.N    R3,??DataTable14_37  ;; 0x400c0004
        MOVS     R4,#+8388608
        STR      R4,[R3, #+0]
//  588   
//  589   //初始化MII管理帧寄存器
