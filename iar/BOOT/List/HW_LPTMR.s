///////////////////////////////////////////////////////////////////////////////
//                                                                            /
// IAR ANSI C/C++ Compiler V6.40.1.53790/W32 for ARM    21/Mar/2014  14:38:49 /
...
// E:\ShawnDocuments\IAR_WorkSpace\LPLD_Quad_V2\source\lib\LPLD\HW\HW_LPTMR.c
//    1 /**
//    2  * @file HW_LPTMR.c
...
//   53   LPTMR0->CSR = 0x00;                   
        ...
        STR      R1,[R0, #+0]
//   54   LPTMR0->PSR = 0x00;
        LDR.N    R0,??DataTable7_5  ;; 0x40040004
        MOVS     R1,#+0
        STR      R1,[R0, #+0]
//   55   LPTMR0->CMR = 0x00;
...
//   74       PORTA->PCR[19] = PORT_PCR_MUX(0x6);       //设置PTA19为脉冲累加
        LDR.N    R0,??DataTable7_7  ;; 0x4004904c
        MOV      R1,#+1536
        STR      R1,[R0, #+0]
...
//   78       PORTC->PCR[5] = PORT_PCR_MUX(0x4);        //设置PTC5为脉冲累加  
        LDR.N    R0,??DataTable7_8  ;; 0x4004b014
        MOV      R1,#+1024
        STR      R1,[R0, #+0]
//   79     }
//   80 
