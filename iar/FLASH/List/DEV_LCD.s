///////////////////////////////////////////////////////////////////////////////
//                                                                            /
// IAR ANSI C/C++ Compiler V6.40.1.53790/W32 for ARM    21/Mar/2014  17:07:36 /
...
//                    \LPLD\DEV\DEV_LCD.c -D LPLD_K60 -lCN                    /
...
// E:\ShawnDocuments\IAR_WorkSpace\LPLD_Quad_V2\source\lib\LPLD\DEV\DEV_LCD.c
//    1 /**
//    2  * @file DEV_LCD.c
...
LPLD_LCD_Reset:
        PUSH     {R7,LR}
//  188   LCD_CLR_RST;
        LDR.W    R0,??DataTable19_3  ;; 0x43fe104c
        MOVS     R1,#+0
        STR      R1,[R0, #+0]
...
//  508   if( Xpos >= MAX_X || Ypos >= MAX_Y )
        UXTH     R0,R0            ;; ZeroExt  R0,R0,#+16,#+16
        CMP      R0,#+320
        BCS.N    ??LPLD_LCD_SetPoint_0
        UXTH     R1,R1            ;; ZeroExt  R1,R1,#+16,#+16
        CMP      R1,#+240
        BCC.N    ??LPLD_LCD_SetPoint_1
//  509   {
//  510     return;
??LPLD_LCD_SetPoint_0:
...
//  630   if(side_length > MAX_X || side_length > MAX_Y)
        ...
        CMP      R7,R0
        BCS.N    ??LPLD_LCD_DrawSquare_0
        UXTH     R7,R7            ;; ZeroExt  R7,R7,#+16,#+16
        CMP      R7,#+241
        BCC.N    ??LPLD_LCD_DrawSquare_1
//  631     return;
...
//  673   if(side_xlength > MAX_X || side_ylength > MAX_Y)
        ...
        UXTH     R7,R7            ;; ZeroExt  R7,R7,#+16,#+16
        CMP      R7,R0
        BCS.N    ??LPLD_LCD_DrawRectangle_0
        UXTH     R8,R8            ;; ZeroExt  R8,R8,#+16,#+16
        CMP      R8,#+241
        BCC.N    ??LPLD_LCD_DrawRectangle_1
//  674     return;
