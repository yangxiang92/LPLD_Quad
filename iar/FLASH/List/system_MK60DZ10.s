///////////////////////////////////////////////////////////////////////////////
//                                                                            /
// IAR ANSI C/C++ Compiler V6.40.1.53790/W32 for ARM    21/Mar/2014  17:07:38 /
...
// E:\ShawnDocuments\IAR_WorkSpace\LPLD_Quad_V2\source\lib\CPU\system_MK60DZ10.c
//    1 /**
...
//   67   WDOG->UNLOCK = (uint16_t)0xC520u;     /* Key 1 */
        LDR.N    R0,??DataTable3_2  ;; 0x4005200e
        MOVW     R1,#+50464
        STRH     R1,[R0, #+0]
...
//   71   WDOG->STCTRLH = (uint16_t)0x01D2u;
        LDR.N    R0,??DataTable3_3  ;; 0x40052000
        MOV      R1,#+466
        STRH     R1,[R0, #+0]
