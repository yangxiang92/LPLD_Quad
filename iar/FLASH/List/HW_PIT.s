///////////////////////////////////////////////////////////////////////////////
//                                                                            /
// IAR ANSI C/C++ Compiler V6.40.1.53790/W32 for ARM    21/Mar/2014  17:07:29 /
...
// E:\ShawnDocuments\IAR_WorkSpace\LPLD_Quad_V2\source\lib\LPLD\HW\HW_PIT.c
//    1 /**
//    2  * @file HW_PIT.c
...
//   56   // 开启 PIT
//   57   PIT->MCR = 0x00;
        LDR.N    R0,??DataTable9_6  ;; 0x40037000
        MOVS     R1,#+0
        STR      R1,[R0, #+0]
//   58  
//   59   if(isr_func != NULL){
