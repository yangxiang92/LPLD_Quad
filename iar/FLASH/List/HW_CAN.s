///////////////////////////////////////////////////////////////////////////////
//                                                                            /
// IAR ANSI C/C++ Compiler V6.40.1.53790/W32 for ARM    21/Mar/2014  17:07:31 /
...
// E:\ShawnDocuments\IAR_WorkSpace\LPLD_Quad_V2\source\lib\LPLD\HW\HW_CAN.c
//    1 /**
//    2  * @file HW_CAN.c
...
//   99       PORTB->PCR[18] = PORT_PCR_MUX(2)| PORT_PCR_PE_MASK | PORT_PCR_PS_MASK; 
        LDR.W    R0,??DataTable19_8  ;; 0x4004a048
        MOVW     R1,#+515
        STR      R1,[R0, #+0]
        B.N      ??LPLD_CAN_Init_6
//  100     }
...
??LPLD_CAN_Init_5:
        LDR.W    R0,??DataTable19_9  ;; 0x40049030
        MOV      R1,#+512
        STR      R1,[R0, #+0]
//  104     }
//  105 
...
//  108       PORTB->PCR[19] = PORT_PCR_MUX(2)| PORT_PCR_PE_MASK | PORT_PCR_PS_MASK; 
        LDR.W    R0,??DataTable19_10  ;; 0x4004a04c
        MOVW     R1,#+515
        STR      R1,[R0, #+0]
        B.N      ??LPLD_CAN_Init_8
//  109     }
...
??LPLD_CAN_Init_7:
        LDR.W    R0,??DataTable19_11  ;; 0x40049034
        MOV      R1,#+512
        STR      R1,[R0, #+0]
        B.N      ??LPLD_CAN_Init_8
//  113     }
...
//  119       PORTC->PCR[17] = PORT_PCR_MUX(2)| PORT_PCR_PE_MASK | PORT_PCR_PS_MASK; 
        LDR.W    R0,??DataTable19_12  ;; 0x4004b044
        MOVW     R1,#+515
        STR      R1,[R0, #+0]
...
??LPLD_CAN_Init_9:
        LDR.W    R0,??DataTable19_13  ;; 0x4004d060
        MOVW     R1,#+515
        STR      R1,[R0, #+0]
//  124     }
//  125 
...
//  128       PORTC->PCR[16] = PORT_PCR_MUX(2)| PORT_PCR_PE_MASK | PORT_PCR_PS_MASK; 
        LDR.W    R0,??DataTable19_14  ;; 0x4004b040
        MOVW     R1,#+515
        STR      R1,[R0, #+0]
        B.N      ??LPLD_CAN_Init_8
//  129     }
...
??LPLD_CAN_Init_11:
        LDR.W    R0,??DataTable19_15  ;; 0x4004d064
        MOVW     R1,#+515
        STR      R1,[R0, #+0]
//  133     }
//  134   } 
...
??LPLD_CAN_InitMessageObject_1:
        LSLS     R1,R1,#+3        ;; ZeroExtS R1,R1,#+3,#+3
        LSRS     R1,R1,#+3
//  421     }
...
`?<Constant "E:\\\\ShawnDocuments\\\\IAR...">`:
        ...
        DC8 48H, 57H, 5FH, 43H, 41H, 4EH, 2EH, 63H
        DC8 0
        DC8 0, 0, 0
